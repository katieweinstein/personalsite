...
const projectData = [
  {
    ...
    description:
      'Developed over a 2-week sprint in a team of four, this project is a fully functional project management board app for groups. We included features like drag and drop, real-time project board updates, and optional site-wide color themes. <br /> <br />I implemented the drag and drop feature, contributed to a large portion of the layout and styling, and created the task forms.',
  ...
  },
  {
    ...
    description:
      "Inspired by my own love of running and the data that comes along with it, I developed this app to provide myself and other Garmin users with lifetime running data. It currently only works for Garmin users, so if you don't run or use a different running app, you can download my data below! <br /> <br />I stored all of the data locally in data structures for quick and easy access - no database needed!",
  ...
  },
  {
    ...
    description:
      'This project was developed with two other teammates in less than a week. We focused on creating carts for both logged-in and guest users, and practiced with large amounts of dummy data to simulate a real-world e-commerce site with hundreds of products. <br /> <br />I handled front-end component organization and styling, contributed to the structure of the database, and created the login and signup forms.',
